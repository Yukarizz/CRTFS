...
@register_model
def T2t_vit_t_14(pretrained=True,inchannel=3, **kwargs):  # adopt transformers for tokens to token

    model = T2T_ViT(tokens_type='transformer', embed_dim=384, depth=14, num_heads=6, mlp_ratio=3.,in_chans=inchannel)
