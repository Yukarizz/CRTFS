...
class decoder_module(nn.Module):
    def __init__(self, dim=384, token_dim=64, img_size=224, ratio=8, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), fuse=True, guide=False):
...
class Decoder(nn.Module):
    def __init__(self, embed_dim=384, token_dim=64, depth=2, img_size=224):
        ...
        self.decoder3 = decoder_module(dim=embed_dim, token_dim=token_dim,  img_size=img_size, ratio=1, kernel_size=(7, 7), stride=(4, 4), padding=(2, 2), fuse=False, guide=True)
        self.decoder3_c = decoder_module(dim=embed_dim, token_dim=token_dim, img_size=img_size, ratio=1, kernel_size=(7, 7), stride=(4, 4), padding=(2, 2), fuse=False, guide=True)
    ...
    def forward(self, saliency_fea_1_16, token_fea_1_16, saliency_tokens, contour_fea_1_16, contour_tokens, rgb_fea_1_8, rgb_fea_1_4,fused_f3_refine,contour_guide_1_4):
        ...
        # 1/4 -> 1
        saliency_fea_1_1 = self.decoder3(saliency_fea_1_4,fused_f3_refine)
        contour_fea_1_1 = self.decoder3_c(contour_fea_1_4,contour_guide_1_4)
        ...
        # saliency_fea_1_1 = saliency_fea_1_1.transpose(1, 2).reshape(B, -1, self.img_size, self.img_size)
        return [mask_1_16, mask_1_8, mask_1_4, mask_1_1], [contour_1_16, contour_1_8, contour_1_4, contour_1_1], saliency_fea_1_4.transpose(1, 2).reshape(B, -1, self.img_size // 4, self.img_size // 4)
