...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, rgb_fea, depth_fea, color_fea):
        ...
        for block in self.blocks:
            rgb_fea, depth_fea = block(rgb_fea, depth_fea, color_fea)
...
class Transformer(nn.Module):
    ...
    def forward(self, rgb_fea, depth_fea,color_fea=None):

        rgb_memory, depth_memory = self.encoderlayer(rgb_fea, depth_fea,color_fea)
